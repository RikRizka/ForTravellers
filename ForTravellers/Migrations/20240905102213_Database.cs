        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Offers = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => x.RegistrationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationRegistrationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Reservations_ReservationRegistrationId",
                        column: x => x.ReservationRegistrationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ReservationRegistrationId",
                table: "Payments",
                column: "ReservationRegistrationId");
